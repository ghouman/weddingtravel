...
public class Recommend {
    ...
    public void setLinkObligate(String linkObligate) {
        this.linkObligate = linkObligate == null ? null : linkObligate.trim();
    }
    ...
    public void setPriceBig(String priceBig) {
        this.priceBig = priceBig == null ? null : priceBig.trim();
    }
    ...
    public void setPriceSmall(String priceSmall) {
        this.priceSmall = priceSmall == null ? null : priceSmall.trim();
    }
    ...
    public void setViewLink(String viewLink) {
        this.viewLink = viewLink == null ? null : viewLink.trim();
    }
