            ...
            <div class="main_con2">
            	...
            	<div class="list_con2">
                	<div id="con2">
                        <ul id="tags2">
                            <li class="selectTag">
                            	<a onclick="selectTag('pic_con0',this)" href="javascript:void(0)">样片案例</a>
                            </li>
                            <li>
                            	<a onclick="selectTag('pic_con1',this)" href="javascript:void(0)">客片案例</a>
                            </li>
                        </ul>
                        <div id="pic_con">
                            <div class="pic_con selectTag" id="pic_con0">
                                  <ul class="pictlist3">
                                    <li>
                                    	<div class="pic_div" onclick="location.href='weddingCase_video.jsp'">
                                            <div></div>
