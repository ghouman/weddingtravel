...
<jsp:include page="head.jsp"></jsp:include>
    <div class="w_m page_dz">
        <div class="index_con_div in_con_div">
            <div class="titles2 hssy_title yahei">
                <h2>婚纱摄影
                </h2>
                <h3>
            ...
            <div class="main_con2">
                <div class="current_page">
                	<a href="婚纱摄影.html" class="cur_a">婚纱摄影</a>&nbsp;>>>&nbsp;
                    <a href="摄影团队.html" class="cur_a">摄影团队</a>&nbsp;>>>&nbsp;
                    摄影师
                </div>
                <div class="list_con4">
                	<div class="titles4">DAISY&nbsp;&nbsp;摄影团队</div>
                    <div class="jq_con">
                        <div class="left_info">
                        	<div class="info_int">
                ...
                <div class="list_con3">
                	<fieldset class="introduction_f">
                    	<legend>DAISY摄影团队简介</legend>
                        <div class="intro_con intro_con2">
                        	<div class="camera_con">
                                <div class="camera_img">
                                    <img src="images/cameraman.png"/>
                                </div>
                                <div class="camera_info">
                                    <div class="camera_info1">
                                        DAISY摄影团队<font>徐晓伟</font>
                                    </div>
                                    <p>
    2009年7月，随世界上著名的新加坡摄影组合 chuando & frey </p><p>
    拍摄MODERN WEEKLY 10周年特别纪念周刊。 </p><p>
    2009年11月，前往美国，对世界上处于时尚摄影高端的城市纽约和洛杉进行实地的考察，包括对摄影经纪机构，摄影棚的建设和摄影行业资源整和摄影团队专业化等的考察。</p><p>
    2010年加入上海圣焱文化传播有限公司(SZAYE)为首席摄影师。
                                    </p>
                                </div>
                            </div>
                            <h5>【品牌客户】：</h5>
<p>奥迪、蒙牛、伊利、多乐士、BELLE、交通银行、美特斯邦
威、青岛啤酒、SV(沙宣）、 VSKONNE、KK啤酒、三星手机、NEW BALANCE、相依本草、HP、肯德基、麦当劳、LACAAR、DIOR、索尼爱立信、森马、7UP等。
</p>
<h5>【时尚杂志】：</h5>
<p>《周末画报》  《MEN’S UNO》  《U+》  《外滩画报》  《MEN ‘S HEALTH》  《GRAZIA》 
 《1626》  《东方壹周》  《品位》  《尚流》等。 </p>
<h5>【合作艺人】：</h5>
<p>周杰伦、杨幂、姜文、林依晨、范冰冰、梁家辉、甄子丹、张扬果尔、谢霆锋、阿兰、李宇春、胡军、林心如、吴克群、陶�、黄小明、米勒等。
                            </p>
                        </div>
                    </fieldset>
                </div>
                        ...
                        <div id="pic_con">
                            <div class="pic_con selectTag list_con6" id="pic_con0">
                             ...
                             <div class="pic_con" id="pic_con1">
                                  <ul class="pictlist">
                                    <li><div class="pic_div" onclick="location.href='list3.jsp'">
